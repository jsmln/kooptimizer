...
DROP FUNCTION IF EXISTS public.sp_get_announcements_by_status(announcement_status_enum);

-- Create the function with updated return type
CREATE FUNCTION public.sp_get_announcements_by_status(p_status announcement_status_enum)
 RETURNS TABLE(
...
-- Verify the update
SELECT * FROM sp_get_announcements_by_status('sent') LIMIT 5;
