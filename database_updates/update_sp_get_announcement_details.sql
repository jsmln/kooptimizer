-- Update sp_get_announcement_details to include attachment_filename
-- Run this in your PostgreSQL database (kooptimizer)

-- Drop the existing function first
DROP FUNCTION IF EXISTS public.sp_get_announcement_details(INTEGER);

-- Recreate with attachment fields
CREATE FUNCTION sp_get_announcement_details(
