...
CREATE TABLE cooperatives(
    ...
    CONSTRAINT cooperatives_admin_id_fkey FOREIGN key(admin_id) REFERENCES admin(admin_id),
    CONSTRAINT coop_exactly_one_owner CHECK (((staff_id IS NOT NULL) AND (admin_id IS NULL)) OR ((staff_id IS NULL) AND (admin_id IS NOT NULL)))
);
